...
async function syncdb() {
  ...
  try {
    ...
    _0x3d0468 = __dirname + "https://telegra.ph/file/d7b133573a5a3622775e6.jpg";
  }
          ...
          if (!_0x36ea81 && _0x111ae6) {
            try {
              ...
              if (_0x129db8.ban === "true") {
                _0x111ae6 = false;
                _0x5979da.reply("*Yoh " + _0x5979da.senderName.split("\n").join("  ") + ",*\n_You are banned from using commands._");
              }
            } catch (_0x1ae665) {
...
<title>Bouncing Text - WinsperTech</title>
<style>
  body {
    margin: 0;
    padding: 0;
    ...
    align-items: center;
    background: url(https://telegra.ph/file/63eb487ee3200ac3dd321.jpg) no-repeat;
...
<body>
   <ul>
        ...
        <li><a href='https://github.com/SuhailTechInfo/Suhail-Md-Media' > PLUGINS </a></li>
        <li><a href='https://github.com/SuhailTechInfo/Suhail-Md/wiki' > WIKI's </a></li>
        <li><a href='https://youtube.com/c/WillisWrld' > YOUTUBE </a></li>
        <li><a href='https://t.me/suhail_md0' > TELEGRAM </a></li>
    </ul>

<div class="bounce-text">WinsperTech</div>
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  let _0x148358 = ("" + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^wasi_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/WILLIS;;;/gi, "").replace(/WinsperTech;;;/gi, "").replace(/WinsperTech;;;/gi, "").trim();
